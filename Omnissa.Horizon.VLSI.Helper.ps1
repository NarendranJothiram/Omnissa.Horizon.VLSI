# Requires -Modules Omnissa.Horizon.VLSI
#######################################
...
# Place the folder Omnissa.Horizon.VLSI in this location for Import to work

# Uncomment this to load the module from current folder location
Import-Module "$PSScriptRoot\Omnissa.Horizon.VLSI\1.0\Omnissa.Horizon.VLSI.psm1" -Force

#Import-Module Omnissa.Horizon.VLSI -Force
...
# Sample to list RDSServerSummaryView API call, response is array of RDSServers
Get-RDSServerSummaryView $SessionInfo

# Sample to list RDSServerSummaryView API call, response is array of RDSServers
Get-FarmHealthInfo $SessionInfo

# Generic method of query based on entity name.
Get-QueryByEntityType $SessionInfo "FarmHealthInfo"
